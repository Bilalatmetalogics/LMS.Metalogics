...
export default function LandingPage() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-[var(--sidebar)] text-white">
      {/* Mesh gradient — matches Lovable exactly */}
      ...
      <div className="relative z-10">
        ...
        <header className="flex items-center justify-between px-6 py-5 sm:px-10">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-base font-semibold tracking-tight">
              MetaLogics <span className="text-white/60">LMS</span>
            </span>
          </div>
        ...
        <main className="px-6 sm:px-10">
          ...
          <section className="mx-auto max-w-4xl py-20 text-center sm:py-28">
            <span className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-3 py-1 text-xs uppercase tracking-wider text-white/70">
              <Sparkles className="h-3 w-3" /> Internal Training Platform
            </span>
            ...
            <p className="mx-auto mt-5 max-w-2xl text-base text-white/70 sm:text-lg">
              The MetaLogics learning platform — modern, role-aware, and built
            ...
            <div className="mt-8 flex items-center justify-center gap-3 flex-wrap">
              <Link
                href="/login"
                className="flex items-center gap-2 px-6 py-3 text-sm font-semibold text-white bg-gradient-primary rounded-xl shadow-glow hover:opacity-90 transition-all"
              >
          ...
          <section className="mx-auto max-w-4xl mb-16">
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {stats.map(({ icon: Icon, label, value }) => (
                ...
                >
                  <Icon className="h-5 w-5 text-[var(--primary-glow)] mx-auto mb-2" />
          ...
          {/* ── Feature cards — glass-panel matches Lovable exactly ── */}
